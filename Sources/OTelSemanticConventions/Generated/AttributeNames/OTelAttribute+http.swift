...
extension OTelAttribute {
    ...
    public enum http {
        ...
        #if Experimental
        /// `http.flavor` **UNSTABLE**: Deprecated, use `network.protocol.name` and `network.protocol.version` instead.
        ///
        /// - Stability: development
        /// - Type: enum
        ///     - `1.0`: HTTP/1.0
        ...
        ///     - `SPDY`: SPDY protocol.
        ///     - `QUIC`: QUIC protocol.
        @available(*, deprecated, message: "Split into `network.protocol.name` and `network.protocol.version`")
