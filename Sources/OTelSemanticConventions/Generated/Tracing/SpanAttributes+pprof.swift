    ...
    public struct PprofAttributes: SpanAttributeNamespace {
        ...
        public struct ProfileAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var docUrl: SpanAttributeKey<String> { .init(name: OTelAttribute.pprof.profile.docUrl) }
                ...
                /// - Type: string
                /// - Example: `/foobar/`
                public var dropFrames: SpanAttributeKey<String> { .init(name: OTelAttribute.pprof.profile.dropFrames) }
