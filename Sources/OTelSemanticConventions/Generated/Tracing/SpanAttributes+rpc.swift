    ...
    public struct RpcAttributes: SpanAttributeNamespace {
        ...
        public struct JsonrpcAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `rpc.jsonrpc.error_message` **UNSTABLE**: Deprecated, use the span status description when reporting JSON-RPC spans.
                ///
                /// - Stability: development
                /// - Type: string
                /// - Examples:
                ///     - `Parse error`
                ///     - `User already exists`
                @available(*, deprecated, message: "Use the span status description when reporting JSON-RPC spans.")
