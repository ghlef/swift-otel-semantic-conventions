...
extension SpanAttributes {
    ...
    public var oracleCloud: OracleCloudAttributes {
        get {
    ...
    @dynamicMemberLookup
    public struct OracleCloudAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var realm: SpanAttributeKey<String> { .init(name: OTelAttribute.oracleCloud.realm) }
        }
    }
    #endif
}
